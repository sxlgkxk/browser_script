...
let ignore_html=`<details><summary id="ignored_summary">ignored words</summary><table style='width: 100%'>`
	...
	*/
	_tr_html=`<tr id="w-`+word+`">
		<td style="text-align: right; padding-right:20px;width: 120px;" class="w-`+type+` w-`+type+`-title">`
			+word
		+`</td>`
	_tr_html+=`<td style="width:30px">`
			+`<button style="background-color:#444; color:#666 ;border:0; margin-top:4px;margin-bottom:4px" class="w-modify" word="`+word+`">+</button>
		</td>`
